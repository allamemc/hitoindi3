        ...
        <div class="py-6 sm:px-6 lg:px-8">
          ...
          <div class="mx-auto max-w-2xl sm:text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900
              sm:text-4xl">Consulta los precios</h2>
            <p class="mt-6 text-lg leading-8 text-gray-600">Disponemos de <span class="text-gray-800">tres</span> planes de trabajo distintos</p>
          </div>
<br>
<br>
<div class="flex flexion">
          <div class="w-1/2 max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
